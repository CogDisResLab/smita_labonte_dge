...
dge <- read.csv("Galaxy Output/NA/NA_Medication_DGE.csv") %>% mutate(GeneID = as.character(GeneID))
...
count <- read.csv("Galaxy Count Matrix Output/NA/NA_Male_Med_Counts.csv") %>% mutate(Geneid = as.character(Geneid))
