...
dge <- read.csv("Galaxy Output/AI/AI_Female_DGE.csv") %>% mutate(GeneID = as.character(GeneID))
...
drugfind_results <- investigate_signature(dge, "CP",
                                          ...
                                          logfc_column = "logFC",
                                          pval_column = "PValue",
                                          source_name = "AI_Female") |>

  write_csv("figures/DrugFindR_Output/AI/AI_Female1.csv")
...
drugfind_results_2 <- investigate_signature(dge, "CP",
                                            ...
                                            pval_column = "PValue",
                                            source_name = "AI_Female") |>
  write_csv("figures/DrugFindR_Output/AI/AI_Female2.csv")
