...
dge <- read.csv("Galaxy Output/OFC/OFC_Medication_DGE.csv") %>% mutate(GeneID = as.character(GeneID))
...
count <- read.csv("Galaxy Count Matrix Output/OFC/OFC_Male_Med_Counts.csv") %>% mutate(Geneid = as.character(Geneid))
