...
dge <- read.csv("Galaxy Output/NA/NA_Female_DGE.csv") %>% mutate(GeneID = as.character(GeneID))
...
drugfind_results <- investigate_signature(dge, "CP",
                                          ...
                                          logfc_column = "logFC",
                                          pval_column = "PValue",
                                          source_name = "NA_Female") |>

  write_csv("figures/DrugFindR_Output/NA/NA_Female1.csv")
...
drugfind_results_2 <- investigate_signature(dge, "CP",
                                            ...
                                            pval_column = "PValue",
                                            source_name = "NA_Female") |>
  write_csv("figures/DrugFindR_Output/NA/NA_Female2.csv")
