...
diffexp <- replace(diffexp, is.na(diffexp), 0) |>
  ...
  write_csv("results/Human_DGE-L1000_Matrix_Male_topbottom5.csv")


# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/Human_DGE-L1000_Matrix_Male_topbottom5.csv") |>
