...
# Comparison: Mouse PFC top/bottom 5% from L1000 Overall
...
pfc_up_sig <- pfc_dge_sig |>
  ...
  write_csv("results/6. Mouse DrugFindR Output/Mouse-PFC/5%fromL1000/Overall/Mouse_PFC_L1000_5%_overall_top_genes_sig.csv")

#Create a file listing bottom X% gene signature
pfc_dn_sig <- pfc_dge_sig |>
  filter_signature("down", threshold = 0) |>
  write_csv ("results/6. Mouse DrugFindR Output/Mouse-PFC/5%fromL1000/Overall/Mouse_PFC_L1000_5%_overall_bottom_genes_sig.csv")
