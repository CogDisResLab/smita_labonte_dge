...
# Comparison: CG L1000 Males Meds
...
cg_up_concordants <- get_concordants(cg_dge_sig)

#Extract discordant CPs for the L1000 genes
cg_dn_concordants <- get_concordants(cg_dge_sig)

#Combine all CPs and filter
cg_concordants_all <- cg_up_concordants |>
