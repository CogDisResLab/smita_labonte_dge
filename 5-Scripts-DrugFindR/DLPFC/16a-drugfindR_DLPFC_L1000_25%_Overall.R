...
# Comparison: DLPFC top/bottom 25% from L1000 Overall
...
dlpfc_up_sig <- dlpfc_dge_sig |>
  ...
  write_csv("results/6. DrugFindR Output/DLPFC/25%fromL1000/Overall/DLPFC_L1000_25%_overall_top_genes_sig.csv")

#Create a file listing bottom X% gene signature
dlpfc_dn_sig <- dlpfc_dge_sig |>
  filterSignature("down", threshold = 0) |>
  write_csv ("results/6. DrugFindR Output/DLPFC/25%fromL1000/Overall/DLPFC_L1000_25%_overall_bottom_genes_sig.csv")
...
x <- dlpfc_concordants_all %>%
  ...
  deframe() %>%
  writexl::write_xlsx("results/6. DrugFindR Output/DLPFC/25%fromL1000/Overall/DLPFC_L1000_25%_Overall_drugfindr.xlsx")
