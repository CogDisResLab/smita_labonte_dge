...
dge <- read.csv("Galaxy Output/Mouse NA/Mouse_NA_Females_DGE.csv") %>% mutate(GeneID = as.character(GeneID))
...
drugfind_results <- investigate_signature(dge, "CP",
                                          ...
                                          logfc_column = "logFC",
                                          pval_column = "PValue",
                                          source_name = "Mouse_NA_Female") |>

  write_csv("figures/DrugFindR_Output/Mouse NA/Mouse_NA_Female1.csv")
...
drugfind_results_2 <- investigate_signature(dge, "CP",
  ...
  write_csv("figures/DrugFindR_Output/Mouse NA/Mouse_NA_Female2.csv")
