...
ofc_dge <- read_csv("results/kallisto/Orbitofrontal_Cortex_overall_dge.csv")

ofc_count <- read_csv("data/kallisto/Orbitofrontal_Cortex_clean_count.csv")
