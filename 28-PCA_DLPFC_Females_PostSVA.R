...
dlpfc_count_female <- DLPFC_count_filtered[, DLPFC_metadata_truncated[,1] == "female"]
...
pca.data <- data.frame(Sample=rownames(pca$x),
                       X=pca$x[,1],
                       Y=pca$x[,2],
                       Sex=DLPFC_metadata$gender[DLPFC_metadata$gender == "female"],
                       Diagnosis=DLPFC_metadata$phenotype[DLPFC_metadata$gender == "female"],
                       Death=DLPFC_metadata$Cause_of_death[DLPFC_metadata$gender == "female"])
pca.data
