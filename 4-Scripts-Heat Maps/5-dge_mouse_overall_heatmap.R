# Extract L1000 from DGEs for each brain region and generate heat map (Mouse Overall Comparison)
...
diffexp <- dge_na_symboled |>
  ...
  write_csv("results/3. Mouse L1000 Heat Maps No SVA/Overall/Mouse_DGE_L1000_Overall_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/3. Mouse L1000 Heat Maps No SVA/Overall/Mouse_DGE_L1000_Overall_Matrix.csv") |>
