# Extract top bottom 5% of genes from L1000 for each brain region and generate heat map (Mouse Females Comparison)
...
diffexp <- replace(diffexp, is.na(diffexp), 0) |>
  ...
  write_csv("results/4. Mouse Top 5% Heat Maps No SVA/Females/Mouse_DGE_L10005%_Females_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/4. Mouse Top 5% Heat Maps No SVA/Females/Mouse_DGE_L10005%_Females_Matrix.csv") |>
