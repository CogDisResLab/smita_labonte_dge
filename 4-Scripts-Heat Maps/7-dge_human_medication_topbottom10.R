# Extract top bottom 10% of genes from L1000 for each brain region and generate heat map (Males Meds Comparison)
...
diffexp <- replace(diffexp, is.na(diffexp), 0) |>
  write_csv("results/5. Top 10% Heat Maps Post SVA/Males Meds/Human_DGE_L1000_10%_Males_Meds_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/5. Top 10% Heat Maps Post SVA/Males Meds/Human_DGE_L1000_10%_Males_Meds_Matrix.csv") |>
