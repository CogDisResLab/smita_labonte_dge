# Extract top bottom 5% of genes from L1000 for each brain region and generate heat map (Overall Comparison)
...
write_csv("results/4. Top 5% Heat Maps Post SVA/Overall/Human_DGE_L10005%_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/4. Top 5% Heat Maps Post SVA/Overall/Human_DGE_L10005%_Matrix.csv") |>
