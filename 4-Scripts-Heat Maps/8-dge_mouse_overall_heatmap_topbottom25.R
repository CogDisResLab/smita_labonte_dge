# Extract top bottom 25% of genes from L1000 for each brain region and generate heat map (Mouse Overall Comparison)
...
diffexp <- dge_na_selected |>
  ...
  write_csv("results/4. Mouse Top 25% Heat Maps No SVA/Overall/Mouse_DGE_L100025%_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/4. Mouse Top 25% Heat Maps No SVA/Overall/Mouse_DGE_L100025%_Matrix.csv") |>
