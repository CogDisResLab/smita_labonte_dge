# Extract top bottom 5% of genes from L1000 for each brain region and generate heat map (Females Comparison)
...
diffexp <- replace(diffexp, is.na(diffexp), 0) |>
  write_csv("results/4. Top 5% Heat Maps Post SVA/Females/Human_DGE_L10005%_Females_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/4. Top 5% Heat Maps Post SVA/Females/Human_DGE_L10005%_Females_Matrix.csv") |>
