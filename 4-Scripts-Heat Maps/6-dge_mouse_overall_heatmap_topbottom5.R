# Extract top bottom 5% of genes from L1000 for each brain region and generate heat map (Mouse Overall Comparison)
...
diffexp <- dge_na_selected |>
  ...
  write_csv("results/4. Mouse Top 5% Heat Maps No SVA/Overall/Mouse_DGE_L10005%_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/4. Mouse Top 5% Heat Maps No SVA/Overall/Mouse_DGE_L10005%_Matrix.csv") |>
