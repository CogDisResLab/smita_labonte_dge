# Extract top bottom 10% of genes from L1000 for each brain region and generate heat map (Mouse Females Comparison)
...
diffexp <- replace(diffexp, is.na(diffexp), 0) |>
  ...
  write_csv("results/5. Mouse Top 10% Heat Maps No SVA/Females/Mouse_DGE_L1000_10%_Females_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/5. Mouse Top 10% Heat Maps No SVA/Females/Mouse_DGE_L1000_10%_Females_Matrix.csv") |>
