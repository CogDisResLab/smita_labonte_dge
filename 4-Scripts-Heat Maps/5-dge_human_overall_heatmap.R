# Extract L1000 from DGEs for each brain region and generate heat map (Overall Comparison)
...
diffexp <- dge_ai |>
  ...
  write_csv("results/3. L1000 Heat Maps Post SVA/Overall/Human_DGE_L1000_Overall_Matrix.csv")

# Heatmap Generation ------------------------------------------------------

diff_expr_modified <- read_csv("results/3. L1000 Heat Maps Post SVA/Overall/Human_DGE_L1000_Overall_Matrix.csv") |>
