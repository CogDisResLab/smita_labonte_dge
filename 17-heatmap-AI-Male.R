...
dge <- read.csv("Galaxy Output/AI/AI_Male_DGE.csv") %>% mutate(GeneID = as.character(GeneID))
...
count <- read.csv("Galaxy Count Matrix Output/AI/AI_Male_Counts.csv") %>% mutate(Geneid = as.character(Geneid))
